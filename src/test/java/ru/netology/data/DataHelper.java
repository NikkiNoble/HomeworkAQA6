...
public class DataHelper {
    ...
    public static CardInfo getCardInfo1() {
        return new CardInfo("5559_0000_0000_0001", new PersonalAccountPage().returnOtherBalance());
    }

    public static CardInfo getCardInfo2() {
        return new CardInfo("5559_0000_0000_0002", new PersonalAccountPage().returnBalance());
    }

    public static String shouldReturnARandomAmount() {
